...
createApp({
    setup() {
        ...
        const accountSort = ref({ field: null, desc: false });const { createApp, ref, computed, watch, onMounted, nextTick } = Vue;
    ...
    setup() {
        ...
        const processNodeData = (data) => {
            ...
            currentPoolMap.forEach(n => {
                ...
                if ((n.region || '').toLowerCase() !== 'england') return; // idem para región
